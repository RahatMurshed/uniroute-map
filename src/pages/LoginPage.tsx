    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden md:flex md:w-1/2 bg-secondary items-center justify-center relative overflow-hidden">
        ...
        <div className="relative text-center text-secondary-foreground space-y-6 px-8">
          <img src="/uniroute-logo.png" alt="UniRoute" className="h-28 w-28 mx-auto object-contain" />
          <h1 className="text-3xl font-extrabold tracking-tight">UniRoute</h1>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="md:hidden bg-secondary px-6 py-8 text-secondary-foreground text-center safe-top">
          <img src="/uniroute-logo.png" alt="UniRoute" className="h-16 w-16 mx-auto mb-3 object-contain" />
          <h1 className="text-2xl font-extrabold tracking-tight">UniRoute</h1>
          <p className="text-sm text-secondary-foreground/70 mt-1">Real-Time Bus Tracker</p>
        </div>
